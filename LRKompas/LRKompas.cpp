...
// LRKompas.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLRKompasApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CLRKompasApp::OnAppAbout)
...
// Создание CLRKompasApp

CLRKompasApp::CLRKompasApp() noexcept
{
	...
	SetAppID(_T("LRKompas.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CLRKompasApp

CLRKompasApp theApp;


// Инициализация CLRKompasApp

BOOL CLRKompasApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CLRKompasDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CLRKompasView));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CLRKompasApp
